...
<head>
    ...
    <title>Email Change Verification - IHealthLink</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p class="welcome">
                You've requested to change your email address in IHealthLink. Please use the verification code below to confirm your new email address.
            </p>
            ...
            <div class="instructions">
                ...
                <ol>
                    <li>Return to the IHealthLink app or website</li>
                    <li>Enter the verification code above</li>
                    <li>Confirm the email change</li>
                    <li>You'll be all set!</li>
                </ol>
            </div>
            ...
            <div class="contact-info">
                ...
                If you didn't request this email change, please contact our support team immediately at support@ihealthlink.gov.ph or ignore this message.
            </div>
