...
<head>
    ...
    <title>BHW Credentials - IHealthLink</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .header {
            background: linear-gradient(135deg, #328E6E 0%, #279EFF 100%);
            padding: 40px 20px;
            text-align: center;
        }
        ...
        .credentials-box {
            background: linear-gradient(135deg, rgba(50, 142, 110, 0.05) 0%, rgba(39, 158, 255, 0.05) 100%);
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>Barangay Health System</h1>
            <p>BHW Account Created Successfully</p>
        </div>
        
        <!-- Content -->
        <div class="content">
            <p class="welcome">
                Welcome to IHealthLink! Your Barangay Health Worker account has been successfully created. Please use the credentials below to access the system.
            </p>
            ...
            <div class="security-warning">
                ...
                Please change your password immediately after logging in. Do not share your credentials with anyone.
            </div>
            ...
            <div class="instructions">
                ...
                <ol>
                    <li>Log in to IHealthLink using your email and password</li>
                    <li>Navigate to Settings and change your password</li>
                    <li>Complete your profile information</li>
                    <li>Begin accessing health records and data</li>
                </ol>
            </div>
            ...
            <div class="contact-info">
                ...
                If you have any questions or encounter any issues logging in, please contact our support team at support@ihealthlink.gov.ph
            </div>
