...
<body>
    <div class="container">
        ...
        <div class="content">
            <p class="welcome">
                We received a request to reset your password for your IHealthLink account. Use the verification code below to proceed with resetting your password.
            </p>
            
            <!-- Verification Code -->
            <div class="verification-box">
                <span class="code-label">Your Password Reset Code:</span>
                <div class="verification-code">{{ $plainToken }}</div>
            ...
            <div class="security-warning">
                ...
                Never share this code with anyone. IHealthLink staff will never ask for your reset code.
            </div>
            ...
            <div class="instructions">
                ...
                <ol>
                    <li>Return to the IHealthLink login page</li>
            ...
            <div class="contact-info">
                ...
                If you didn't request a password reset, please contact our support team immediately at support@ihealthlink.gov.ph or ignore this message.
            </div>
