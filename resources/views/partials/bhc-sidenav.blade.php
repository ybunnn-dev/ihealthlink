<div x-data="sideMenu()" class="relative flex flex-col min-h-screen hidden xl:flex">
    {{-- Sidebar --}}
   <div
        {{-- Removed transition and dynamic width, added fixed width and border --}}
        class="xl:w-60 border-r border-gray-200 bg-f7 text-white h-full flex flex-col pt-5"
    >
        

       {{-- Navigation --}}
        <ul class="flex-1 text-fluid-sm xl3:text-sm px-3">
                ...
                @if (Auth::user()->role_id == 2)
                    <li class="flex items-center group ">
                        ...
                        >
                            ...
                            {{-- Simplified :class, removed open/close logic --}}
                            <span class="ml-3 whitespace-nowrap transition-all duration-200 text-main_font text-fluid-sm rounded-lg"
                                :class="{ 
