        ...
        <ul class="flex-1 mt-10">
            ...
            <li class="flex items-center group">
                ...
                <a href="#"
                   ...
                   @click="setActive('home')"
                >       
                        <svg class="w-5 h-5 text-main_font" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">
                        <g>
            ...
            <li class="flex items-center group">
                <a href="#"
                   ...
                   @click="setActive('home')"
                >       
                        <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-main_font" fill="currentColor">
                            <g>
