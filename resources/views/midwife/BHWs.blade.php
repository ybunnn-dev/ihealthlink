                    ...
                    <div class="grid grid-rows-1">
                            ...
                            <div class="grid grid-cols-1 slg2:grid-cols-7 gap-3">
                                ...
                                <div class="col-span-1">
                                    ...
                                    <button id="filterBy" 
                                        ...
                                        <span id="filterByText">Alphabetical</span>
                                    ...
                                    <div id="filterDropdownMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="filterBy">
                                            <li>
                                                <a href="#" data-filter="alphabetical" class="block px-4 py-2 hover:bg-gray-100 filter-option">Alphabetical</a>
                                            </li>
                                            <li>
                                                <a href="#" data-filter="age_asc" class="block px-4 py-2 hover:bg-gray-100 filter-option">Age Ascending</a>
                                            </li>
                                            <li>
                                                <a href="#" data-filter="age_desc" class="block px-4 py-2 hover:bg-gray-100 filter-option">Age Descending</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-1">
                                    ...
                                    <button id="dateFilter" 
                                        ...
                                        x-bind:disabled="!showPrivacy" 
                                        x-bind:title="!showPrivacy ? 'Enable privacy view to use dropdown' : ''"
                                        class="w-full text-main_font disabled:bg-gray-200 bg-f7 focus:outline-none font-medium border border-navboard rounded-lg text-sm px-4 py-2 text-center inline-flex items-center justify-between h-[2.375rem]" type="button">
                                        <span id="dateFilterText">All</span>
                                        <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                        </svg>
                                    </button>
                                    ...
                                    <div id="dateDropdownMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dateFilter">
                                            <li>
                                                <a href="#" data-date="all" class="block px-4 py-2 hover:bg-gray-100 date-option">All</a>
                                            </li>
                                            <li>
                                                <a href="#" data-date="last_week" class="block px-4 py-2 hover:bg-gray-100 date-option">Last Week</a>
                                            </li>
                                            <li>
                                                <a href="#" data-date="last_month" class="block px-4 py-2 hover:bg-gray-100 date-option">Last Month</a>
                                            </li>
                                            <li>
                                                <a href="#" data-date="last_year" class="block px-4 py-2 hover:bg-gray-100 date-option">Last Year</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="relative overflow-x-auto py-6">
                            <table class="w-full text-sm text-left text-main_font bg-col_tab_h">
                                ...
                                <tbody id="bhw-table-body">
                                    @include('components.bhw.bhw-table', ['bhws' => $bhws])
                                </tbody>
                            </table>
                        </div>

                        <!-- Pagination -->
                        <div id="bhw-pagination" class="mt-4">
                            {{ $bhws->links() }}
                        </div>
                    </div>
                </div>
