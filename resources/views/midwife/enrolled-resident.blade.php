        ...
        <div class="max-w-[90rem] mx-auto sm:px-6 lg:px-8">
             ...
             <div class="grid grid-cols-1 xl:grid-cols-3 gap-3 mb-4 h-full">
                    ...
                    <div class="grid grid-rows-5 gap-2 col-span-1 h-full">
                        <!-- Profile Card -->
                        <div class="h-full bg-f7 rounded-lg flex flex-col items-center justify-center p-4 row-span-3"> 
                       ...
                       <div class="h-full bg-white rounded-xl shadow-sm p-12 flex flex-col justify-between row-span-2">
                            <div>
                                <div class="flex items-center justify-center h-12 w-12 rounded-full bg-maingreen/20 mb-5">
                                    <svg class="w-5 h-5 text-maingreen"
                                ...
                                <p class="text-main_font font-bold text-xl">
                                    {{ $enrolledResident->program->name }}
                                </p> 
                                
                                <p class="text-normal_font font-medium text-md mt-1">
