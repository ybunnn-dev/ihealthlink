                        ...
                        <div class="pb-6 w-full">
                            <div class="grid grid-cols-1 slg2:grid-cols-7 xl:grid-cols-9 gap-4 w-full items-end">
                                ...
                                <div class="col-span-1 slg2:col-span-2 grid grid-cols-4 gap-2">
                                    <button type="button" id="openAddResidentModal" class="col-span-3 slg2:max-w-40 h-[2.375rem] text-white bg-mainblue hover:bg-blue-700 font-medium rounded-lg text-sm px-3 flex items-center justify-center gap-2">
