                        ...
                        <div class="pb-6">
                            <div class="flex flex-col slg2:flex-row slg2:items-end gap-4">
                                ...
                                <div class="flex flex-col xs:flex-row gap-4 slg2:items-end flex-none">
                                    ...
                                    <div class="w-full xs:w-40 pt-5 xs:pt-0">
                                        <button id="find-resident-qr" 
                                        x-bind:disabled="!showPrivacy" 
                                        x-bind:title="!showPrivacy ? 'Enable privacy view to use qr scanner' : ''"
                                        type="button" class="w-full h-[2.375rem] text-mainblue bg-white border border-mainblue disabled:hover-none disabled:bg-gray-200 hover:bg-gray-200 font-medium rounded-lg text-sm px-3 flex items-center justify-center gap-2">
