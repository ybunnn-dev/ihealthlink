<x-app-layout>
                    ...
                    <div class="pb-6">
                        <div class="flex flex-col slg2:flex-row slg2:items-end gap-4">
                            ...
                            <div class="flex flex-col xs:flex-row gap-4 slg2:items-end flex-none">
                                ...
                                <div class="w-full xs:w-40 pt-5 xs:pt-0">
                                    <button id="scan-qr-button" type="button" class="w-full h-[2.375rem] text-mainblue bg-white border border-mainblue hover:bg-gray-200 font-medium rounded-lg text-sm px-3 flex items-center justify-center gap-2">
    ...
    <script>
        ...
        const householdHeadInput = document.getElementById('enterHouseholdHead'); // This is the input field you want to populate
        ...
        function openQrScannerModal() {
            ...
            qrScannerModal.classList.remove('hidden'); // Show the scanner modal
            ...
            html5QrcodeScanner.start(
                ...
                (decodedText, decodedResult) => {
                    ...
                    // Populate the household head input field with the scanned data
                ...
                (errorMessage) => {
                    // Error callback: for scanning failures
                }
            ).catch(err => {
                console.error("Failed to start scanner: ", err);
                qrStatus.textContent = 'Failed to start camera. Please check permissions.';
            });
        }
        ...
        function stopQrScanner() {
            if (html5QrcodeScanner) {
                html5QrcodeScanner.stop().then(() => {
                    ...
                    addFamilyModal.classList.remove('hidden'); // Show the first modal again
                }).catch(err => {
