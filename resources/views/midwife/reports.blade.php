        ...
        <div class="max-w-[90rem] mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl overflow-hidden p-6 mb-3">
                <div class="grid grid-cols-1 lg2:grid-cols-7 xl:items-end gap-4">
                   <div class="grid grid-cols-1 lg:grid-cols-3 items-end col-span-1 lg:col-span-3 gap-3"> 
                        ...
                        <div class="w-full col-span-1" >
                            <button id="clearFilter" class="w-full text-white bg-mainblue focus:outline-none font-medium border border-mainblue rounded-lg hover:border-white hover:bg-nav_active text-sm px-4 py-2 inline-flex items-center justify-center h-[2.375rem]" type="button">
                                Clear Filters
                            </button>
                        </div>
                        <div class="w-full col-span-1">
