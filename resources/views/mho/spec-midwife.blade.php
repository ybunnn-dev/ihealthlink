                ...
                <div class="grid grid-cols-1 slg:grid-cols-3 gap-3 mb-4">
                    <div class="w-full flex flex-col col-span-1">
                        ...
                        <div class="grid grid-cols-1 slg:grid-cols-2 gap-3">
                            <button id="edit-midwife-btn" type="button" class="col-span-1 px-5 py-3 text-sm font-medium text-white bg-mainblue rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300">Edit</button>
                            <button id="remove-midwife-btn" type="button" class="col-span-1 px-5 py-3 text-sm font-medium text-mainblue bg-white border border-mainblue rounded-lg hover:bg-blue-50 focus:outline-none focus:ring-4 focus:ring-blue-300">Remove</button>
                        </div>
                    </div>
