                            ...
                            <div class="flex flex-col slg2:flex-row slg2:flex-nowrap items-end gap-4">
                                ...
                                <div class="flex flex-col sm:flex-row flex-wrap gap-4 items-end slg2:flex-shrink-0">
                                    ...
                                    <div class="w-full sm:w-40 pt-5 sm:pt-0">
                                        <button type="button" id="page-add-healthProgram-button" class="w-full h-[2.375rem] text-f7 bg-mainblue hover:text-mainblue hover:bg-nav_active font-medium rounded-lg text-sm px-3">Add Program</button>
                                    </div>
                                </div>
                            </div>
                        </div>
