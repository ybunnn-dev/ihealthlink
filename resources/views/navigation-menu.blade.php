<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 border-navboard boarder-main_font">
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="#" class="flex items-center">
                                <svg class="w-4 h-4 mr-3" viewBox="0 0 24 24" fill="none">
                                    <circle cx="12" cy="12" r="12" fill="#0038A8"/>
                                    <path d="M0 12 L12 6 L12 18 Z" fill="#CE1126"/>
                                    <path d="M12 6 L24 12 L12 18 Z" fill="#FFFFFF"/>
                                    <!-- Sun -->
                                    <circle cx="7" cy="9" r="1.5" fill="#FFCD00"/>
                                    <path d="M7 7.5 L7 6.5 M8.5 7.5 L9.5 6.5 M8.5 10.5 L9.5 11.5 M7 10.5 L7 11.5 M5.5 10.5 L4.5 11.5 M5.5 7.5 L4.5 6.5" stroke="#FFCD00" stroke-width="0.3"/>
                                    <!-- Stars -->
                                    <polygon points="5,11 5.2,11.6 5.8,11.6 5.3,12 5.5,12.6 5,12.2 4.5,12.6 4.7,12 4.2,11.6 4.8,11.6" fill="#FFCD00"/>
                                    <polygon points="7,12.5 7.2,13.1 7.8,13.1 7.3,13.5 7.5,14.1 7,13.7 6.5,14.1 6.7,13.5 6.2,13.1 6.8,13.1" fill="#FFCD00"/>
                                    <polygon points="9,11 9.2,11.6 9.8,11.6 9.3,12 9.5,12.6 9,12.2 8.5,12.6 8.7,12 8.2,11.6 8.8,11.6" fill="#FFCD00"/>
                                </svg>
                                Filipino
                            </x-dropdown-link>
                        </x-slot>
                            ...
                            @else
                               <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex flex-col items-start px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                        ...
                                        <p class="text-semibold text-main_font">{{ Auth::user()->name }}</p>
