                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                               ...
                               <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex flex-col items-start px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                        <div class="flex items-center gap-6">
                                            <img class="justify-start size-8 rounded-full object-cover" src="{{ asset(Auth::user()->profile_photo_url) }}" alt="{{ Auth::user()->name }}">
                                            <div class="flex-col items-center">
                                                ...
                                                <span class="text-left text-xs font-normal mt-0.5 text-normal_font">MHO Admin</span>
                                            </div>
                                        </div>
                                    </button>
                                </span>
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('midwife.faqs') }}">
                                {{ __('FAQs') }}
                            </x-dropdown-link>
