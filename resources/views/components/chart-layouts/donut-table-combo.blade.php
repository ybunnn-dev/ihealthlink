<div class="grid grid-cols-1 slg2:grid-cols-3 gap-3 mb-3">
    ...
    <div class="bg-white rounded-xl p-6 px-10 shadow-sm h-70 col-span-1 slg2:col-span-2 overflow-x-auto">
