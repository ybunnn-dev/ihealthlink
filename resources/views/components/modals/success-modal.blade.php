<div id="success-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-lg max-h-full">
        <div class="relative bg-white rounded-lg shadow-sm py-10 px-6">
            <div class="flex flex-col items-center justify-center text-center">
                ...
                <h3 id="success-msg-head" class="text-2xl font-semibold text-main_font">
            ...
            <div class="flex items-center justify-center px-4">
                <button id="close-success-modal-button" data-modal-hide="success-modal" type="button" class="text-white bg-mainblue hover:bg-blue-600 font-medium rounded-lg text-md px-8 py-2 text-center transition-colors">Finish</button>
            </div>
        </div>
    </div>
</div>