                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="grid grid-cols-1 gap-3">
                       ...
                       <div class="flex flex-col col-span-1 relative">
                            ...
                            <div id="medCategoryDropdownMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-full absolute top-full mt-1">
                                <ul class="py-2 text-sm text-gray-700" aria-labelledby="medCategoryDropdownButton">
                                    ...
                                    <li>
                                        <button type="button" data-value="Medicine" class="w-full text-left px-4 py-2 hover:bg-gray-100">Medicine</button>
                                    </li>
                                    <li>
                                        <button type="button" data-value="Medical Supplies" class="w-full text-left px-4 py-2 hover:bg-gray-100">Medical Supplies</button>
                                    </li>
                                    <li>
                                        <button type="button" data-value="Equipment" class="w-full text-left px-4 py-2 hover:bg-gray-100">Equipment</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col col-span-1 relative">
                            ...
                            <div id="formDropdownMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-full absolute top-full mt-1">
                                <ul class="py-2 text-sm text-gray-700" aria-labelledby="formDropdownButton">
                                    ...
                                    <li>
                                        <button type="button" data-value="Injection" class="w-full text-left px-4 py-2 hover:bg-gray-100">Injection</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
