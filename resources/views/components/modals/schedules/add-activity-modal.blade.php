<div id="add-activity-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full transition-opacity duration-400 ease-out opacity-0">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <div class="grid grid-cols-1 slg:grid-cols-2 gap-3">
                            <div class="grid grid-cols-1 gap-1 relative col-span-1 mb-3">
                                <label for="activityDate" class="text-sm font-medium text-main_font">DATE</label>
                                <div class="relative max-w-sm w-full">
                                    ...
                                    <input datepicker type="text" id="activityDate" class="border border-gray-300 text-gray-700 rounded-lg p-2.5 pl-10 block w-full" placeholder="Select date">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 gap-1 relative col-span-1 mb-3">
                                <label for="activityTime" class="block text-sm font-medium text-main_font">SELECT TIME</label>
                                <div class="relative max-w-sm w-full">
                                    ...
                                    <input type="time" id="activityTime" class="bg-white border leading-none border-gray-300 text-gray-700 text-sm rounded-lg block w-full p-2.5 pl-4" required />
                                </div>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 gap-1 relative col-span-1 mb-3">
                            <label for="activityVenue" class="text-sm font-medium text-main_font">VENUE</label>
