        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 py-6 md:py-10 px-6 transition-transform duration-300 ease-out scale-95">
            ...
            <div class="p-4 md:p-5">
                <div class="flex items-center justify-center">
                    ...
                    <input id="confirm-edit-household-checkbox" type="checkbox" value="" class="w-5 h-5 text-mainblue bg-gray-100 border-gray-300 rounded focus:ring-mainblue focus:ring-2 cursor-pointer">
                    <label for="confirm-edit-household-checkbox" class="ms-2 text-sm font-medium text-gray-900 cursor-pointer select-none">I have reviewed and confirmed the changes.</label>
                </div>
            </div>
            <div class="flex flex-col-reverse sm:flex-row items-center justify-end border-t border-gray-200 rounded-b dark:border-gray-600 gap-3 pt-6 px-6">
                <button id="confirm-edit-household-cancel" type="button" 
                ...
                <button id="confirm-edit-household-submit" type="button" 
