        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 py-10 px-6 transition-transform duration-300 ease-out scale-95">
            ...
            <div class="flex flex-col items-center justify-center rounded-t mb-6">
                ...
                <p class="text-sm text-gray-700 dark:text-gray-400">
                    Are you sure you want to remove "<strong id="remove-program-name-display" class="text-main_font"></strong>"?
                </p>
            </div>

            <div class="p-4 md:p-5">
                <div class="flex items-center justify-center">
                    <input id="confirm-remove-checkbox" type="checkbox" value="" class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500 dark:focus:ring-red-600">
                    <label for="confirm-remove-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
            ...
            <div class="flex items-center justify-end border-t border-gray-200 rounded-b dark:border-gray-600 gap-3 pt-6 px-6">
                <button id="cancel-remove-program-button" type="button" class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100">
                    Cancel
                </button>
