        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 py-10 px-6">
            ...
            <div class="flex flex-col items-center justify-center rounded-t mb-6">
                <h3 id="fp-modal-title" class="text-xl font-semibold text-main_font">
                    Enroll in Family Planning Program
                </h3>
                <p id="fp-modal-subtitle" class="text-sm text-normal_font">Step 1: Select a Resident</p>
            </div>
            ...
            <div class="p-4 md:p-5 flex flex-nowrap w-full h-[50vh] overflow-x-hidden overflow-hidden">
                ...
                <div id="fp-step-1" class="transition-transform duration-500 ease-in-out w-full flex-shrink-0">
                    {{-- This will include the search, filter, and resident list --}}
                    @include('components.multi-modal-components.family-planning-1')
                </div>

                <!-- Step 2: Family Planning Details -->
                <div id="fp-step-2" class="transition-transform duration-500 ease-in-out w-full flex-shrink-0 hidden">
                    {{-- This will include the client type, source, and method form --}}
             ...
             <div class="flex items-center justify-between border-t border-gray-200 rounded-b dark:border-gray-600 gap-3 pt-6 px-6">
                ...
                <div class="flex gap-3">
                    <button id="fpCancelBtn" data-modal-hide="enroll-family-planning-modal" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100">Cancel</button>
                    <button id="fpBackBtn" type="button" class="hidden py-2.5 px-5 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100">Previous</button>
                </div>
                <!-- Right side: Next/Submit -->
                <div class="flex gap-3">
                    <button id="fpNextBtn" disabled type="button" class="text-white bg-mainblue hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:opacity-50">Next</button>
                </div>
            </div>
        </div>
    </div>
