<div id="edit-resident-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full transition-opacity duration-400 ease-out opacity-0">
    <div class="relative p-4 w-full max-w-6xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-700 w-full flex flex-col max-h-[90vh] transition-transform duration-300 ease-out scale-95">
            ...
            <div class="p-6 space-y-6 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div class="col-span-1">
                        ...
                        <input type="text" id="residentFirstName" class="w-full border border-gray-300 text-gray-700 rounded-lg p-2.5 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="col-span-1">
                        ...
                        <input type="text" id="residentLastName" class="w-full border border-gray-300 text-gray-700 rounded-lg p-2.5 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="col-span-1">
                        ...
                        <input type="text" id="residentMiddleName" class="w-full border border-gray-300 text-gray-700 rounded-lg p-2.5 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="col-span-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div class="col-span-1">
                        ...
                        <input type="text" id="residentContactNo" class="w-full border border-gray-300 text-gray-700 rounded-lg p-2.5 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="col-span-1">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" id="residentAge" class="w-full border border-gray-300 text-gray-500 rounded-lg p-2.5 bg-gray-100" disabled>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                    <div class="col-span-1">
                        <label for="residentStatus" class="block mb-1 text-sm font-medium text-main_font">STATUS<span class="text-red-500 ml-1">*</span></label>
                        <select id="residentStatus" class="w-full border border-gray-300 text-gray-700 rounded-lg p-2.5 bg-white focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="flex flex-col-reverse sm:flex-row items-center justify-end border-t border-gray-200 rounded-b dark:border-gray-600 gap-3 p-6 shrink-0">
                <button id="cancel-button-edit-resident" data-modal-hide="edit-resident-modal" type="button" 
                ...
                <button id="update-resident-button" disabled type="button" 
                    class="w-full sm:w-auto min-w-[10rem] disabled:opacity-50 text-white bg-mainblue hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-colors">
                    Save Changes
                </button>
            </div>
