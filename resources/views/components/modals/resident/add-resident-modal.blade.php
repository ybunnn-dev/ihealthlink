<div id="add-resident-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full transition-opacity duration-400 ease-out opacity-0">
    <div class="relative p-4 w-full max-w-6xl max-h-full">
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 py-10 px-8 max-w-full transition-transform duration-300 ease-out scale-95">
            ...
            <div class="p-4 md:p-5 space-y-4 h-[70vh] overflow-y-auto w-full">
                   <div class="grid grid-cols-1 slg:grid-cols-4 col-span-1 gap-4 mb-4">
                    ...
                    <div class="grid grid-cols-1 slg:grid-cols-4 col-span-1 gap-4 mb-4">
                        ...
                        <div class="flex flex-col col-span-1 relative gap-1">
                            <label for="familyDropdown" class="text-sm font-medium text-main_font">FAMILY<span class="text-red-500 ml-1">*</span></label>
        ...
        <div class="flex flex-col slg:flex-row items-center justify-end border-t border-gray-200 rounded-b dark:border-gray-600 gap-3 pt-6 px-10">
            ...
            <div class="flex w-full slg:w-auto">
                <button id="cancel-button-add-resident" data-modal-hide="add-resident-modal" type="button" class="w-full slg:w-auto py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Cancel</button>
            </div>

            <div class="flex w-full slg:w-auto">
                <button id="add-resident-button" disabled type="button" class="w-full slg:w-[9rem] disabled:opacity-50 text-white bg-mainblue hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Resident</button>
            </div>
