        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 py-6 md:py-10 px-6 transition-transform duration-300 ease-out scale-95">
            <div class="flex flex-col items-center justify-center rounded-t mb-4 text-center">
                ...
                <p class="text-sm text-normal_font mt-2">
                    Are you sure you want to add "<span id="confirm-resident-full-name" class="font-bold text-main_font"></span>"?
                </p>
            </div>
            <div class="p-4 md:p-5">
                <div class="flex items-center justify-center">
                    <input id="confirm-resident-checkbox" type="checkbox" value="" class="w-5 h-5 text-mainblue bg-gray-100 border-gray-300 rounded focus:ring-mainblue focus:ring-2 cursor-pointer">
                    <label for="confirm-resident-checkbox" class="ms-2 text-sm font-medium text-gray-900 cursor-pointer select-none">I confirm this is the correct resident to add.</label>
                </div>
            </div>
            <div class="flex flex-col-reverse sm:flex-row items-center justify-end border-t border-gray-200 rounded-b dark:border-gray-600 gap-3 pt-6 px-6">
                <button id="cancel-add-resident-confirm" type="button" 
                ...
                <button id="confirm-resident-proceed-button" type="button" 
