<div id="chooseFamilyModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full transition-opacity duration-400 ease-out opacity-0">
    <div class="relative p-4 w-full max-w-3xl max-h-full">
        <!-- Wrapper: py-6 mobile, py-10 desktop -->
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 py-6 md:py-10 px-6 transition-transform duration-300 ease-out scale-95">
            ...
            <!-- Body: Flex column to handle scrolling -->
            <div class="p-0 md:p-5 space-y-4 h-[60vh] flex flex-col">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-2 shrink-0">
                    ...
                    <div>
                        <!-- Increased padding (p-3) for touch -->
                        <select id="purokFilterSelect" class="bg-gray-50 border border-gray-300 text-gray-700 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 text-sm">
                ...
                <!-- Scrollable List -->
                <div id="familyCardContainer" class="space-y-3 flex-grow overflow-y-auto border border-gray-200 rounded-lg p-2 md:p-3 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
