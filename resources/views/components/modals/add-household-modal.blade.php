            ...
            <div class="p-4 md:p-5 space-y-4">
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <div class="flex justify-center mb-3">
                        <button id="add-household-qr" class="border border-mainblue rounded-lg px-10 py-3 flex flex-cols justify-center gap-3 items-center font-semibold text-mainblue">
