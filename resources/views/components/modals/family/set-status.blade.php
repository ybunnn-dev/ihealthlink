<div id="set-status-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full transition-opacity duration-400 ease-out opacity-0">
    <div class="relative p-4 w-full max-w-lg max-h-full"> 
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 py-6 md:py-10 px-6 transition-transform duration-300 ease-out scale-95">
            ...
            <div class="flex flex-col items-center justify-center rounded-t mb-6 text-center">
                ...
                <p class="text-sm text-normal_font mt-1">Please select the new status.</p>
            </div>
            ...
            <div class="p-0 md:p-5">
                <div class="grid grid-cols-1 gap-x-4 gap-y-6">
                    ...
                    <div class="col-span-1 relative">
                        ...
                        <div id="statusDropdownMenu" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-full absolute top-full mt-1 border border-gray-100">
            ...
            <!-- 
                Responsive Buttons:
                1. flex-col-reverse: Stacks Cancel below Confirm on mobile.
                2. sm:flex-row: Side-by-side on desktop.
                3. w-full: Buttons span full width on mobile.
            -->
            <div class="flex flex-col-reverse sm:flex-row items-center border-t border-gray-200 rounded-b dark:border-gray-600 gap-3 justify-end pt-6 mt-6 px-6">
                <button id="cancelSetStatusButton" data-modal-hide="set-status-modal" type="button" 
