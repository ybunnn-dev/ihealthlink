    ...
    <div class="relative p-4 w-full max-w-6xl max-h-full">
        <div class="relative bg-white rounded-lg flex flex-col h-[85vh] py-4 px-12">
            ...
            <div class="flex items-center justify-end p-4 md:p-5 border-t border-gray-200 rounded-b">
                ...
                <button id="choosenHouseholdBtn"type="button" class="text-white bg-mainblue hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center ms-3">Change Household</button>
            </div>
        </div>
    </div>
</div>