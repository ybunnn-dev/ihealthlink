<div class="col-span-1">
    ...
    <div class="bg-white p-6 rounded-xl">
        <div class="flex flex-col slg2:flex-row slg2:items-end gap-4 mb-4 justify-end">
                        ...
                        <tr class="bg-white border-b text-normal_font hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center space-x-4">
                                    ...
                                    <button type="button" 
                                            class="js-delete-purok-btn
                                                {{ ($purok->households_count > 0 || $purok->families_count > 0 || $purok->residents_count > 0)
                                                    ? 'text-gray-400 cursor-not-allowed opacity-50'
                                                    : 'text-red1 hover:text-red-900' }}" 
                                            data-purok-id="{{ $purok->id }}" 
                                            title="Delete Purok"
                                            @disabled($purok->households_count > 0 || $purok->families_count > 0 || $purok->residents_count > 0)>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 pointer-events-none" viewBox="0 0 20 20" fill="currentColor">
