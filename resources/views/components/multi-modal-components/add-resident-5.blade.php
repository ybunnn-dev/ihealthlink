<div class="grid grid-cols-1 gap-6 items-start bg-white  max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
        <div class="flex flex-col relative border p-4 rounded-lg">
            <label for="tobaccoStatusSelect" class="text-sm font-medium text-main_font mb-1">Tobacco Use</label>
        ...
        <div class="flex flex-col relative border p-4 rounded-lg justify-center">
                <label for="caffeineDropdown" class="text-sm font-medium text-main_font mb-1">Caffeine Intake</label>
        ...
        <fieldset class="border p-4 rounded-lg lg:col-span-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div class="flex flex-col relative">
                    <label for="alcoholIntakeDropdown" class="text-sm font-medium text-main_font mb-1">Drank alcohol last 12 mos?</label>
                 ...
                 <div class="flex flex-col relative">
                    <label for="alcoholNumDropdown" class="text-sm font-medium text-main_font mb-1">If yes, how often?</label>
     ...
     <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <fieldset class="border p-4 rounded-lg flex items-center">
            <div class="flex flex-col relative w-full">
                <label for="nutritionDropdown" class="text-sm font-medium text-main_font mb-1">Eats high-fat, high-salt, street, or high-sugar foods weekly?</label>
        ...
        <fieldset class="border p-4 rounded-lg flex items-center">
            <div class="flex flex-col relative w-full">
                <label for="physicalActivityDropdown" class="text-sm font-medium text-main_font mb-1">Does moderate physical activity for ≥ 2.5 hours a week?</label>
