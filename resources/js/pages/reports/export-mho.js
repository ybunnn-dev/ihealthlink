...
const updatePdfPreview = () => {
    ...
    const baseUrl = '/mho/reports/preview-community-report';
...
exportBtn.addEventListener('click', () => {
    ...
    switch (selectedFormat) {
        case 'pdf': baseUrl = '/mho/reports/community-report-pdf'; break;
        case 'excel': baseUrl = '/mho/reports/export-excel'; break;
    }
