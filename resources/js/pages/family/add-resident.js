...
const openAddResidentBtn = document.getElementById('add-new');
...
openAddResidentBtn.addEventListener('click', function () {
    ...
    console.log(family);
    completeAddress.value = `${family.household.purok.name}, ${family.household.purok.barangay.name}, Daraga, Albay`;
...
addResidentButton.addEventListener('click', function() {
    ...
    currentResidentPayload = {
        ...
        // Section 3: Household & Family
        family_id: family.id, // Get ID from the hidden div
